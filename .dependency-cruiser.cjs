...
module.exports = {
  forbidden: [
    // Project-specific manually-added rules:
    {
      name: 'util-must-not-import-outside',
      comment: 'util must be a closed helper cluster',
      severity: 'error',
      from: { path: '^app/util/*' },
      to: {
        pathNot: [
          '^app/util/*', // util may be freely interdependent with itself
          '^app/lib/*', // util may use/wrap third party libraries
        ],
      },
    },

    // dependency-cruiser default rules:
    {
      name: 'no-circular',
      severity: 'warn',
      comment:
      ...
      from: {
        pathNot: '^app/util/*',  // util is allowed to have circular dependencies internally
      },
      to: {
        circular: true,
        pathNot: '^app/util/*',  // util is allowed to have circular dependencies internally
    ...
    },
    {
      ...
      from: {
        orphan: true,
        pathNot: [
          // Auto-generated by dependency-cruiser setup
...
// generated: dependency-cruiser@17.3.5 on 2026-01-02T23:03:27.296Z
