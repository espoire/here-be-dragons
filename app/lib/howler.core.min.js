...
!(function () {
      ...
      if (t._webAudio) {
        var v = function () {
          ...
          m.gain.setValueAtTime(e, n.ctx.currentTime),
            ...
            : d._loop ? m.bufferSource.start(0, _, 86400)
  ...
  var r = {},
    ...
    _ = function () {
      if (n.usingWebAudio) {
        try {
          'undefined' != typeof AudioContext ? (n.ctx = new AudioContext())
          : 'undefined' != typeof webkitAudioContext ? (n.ctx = new webkitAudioContext())
          : (n.usingWebAudio = !1);
        } catch (e) {
          n.usingWebAudio = !1;
        }
